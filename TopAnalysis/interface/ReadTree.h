...
std::vector<float> getLeptonTriggerScaleFactor(int l_id,float l_pt,float l_eta,bool isData);
std::vector<float> getLeptonSelectionScaleFactor(int l_id,float l_pt,float l_eta,bool isData);
std::vector<float> getLeptonEnergyScale(int l_id,float l_pt,float l_eta,bool isData);
