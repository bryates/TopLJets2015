...
struct CharmEvent_t
{
  ...
  Float_t sfs[50],sfsu[50]; //need to split into separate parts
  Float_t ht,met,st;
  Int_t nlj;
  ...
  Float_t d0_pi_pt[50],d0_pi_eta[50],d0_pi_phi[50],d0_pi_dxy[50],d0_pi_dz[50];
  Float_t d0_k_pt[50],d0_k_eta[50],d0_k_phi[50],d0_k_dxy[50],d0_k_dz[50],d0_chi2[50];
