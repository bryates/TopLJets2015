...
void createCharmEventTree(TTree *t, CharmEvent_t &ev)
{
  ...
  */
  ...
  t->Branch("d0_pi_pt_gen",      ev.d0_pi_pt_gen,       "d0_pi_pt_gen[nmeson]/F");
  t->Branch("d0_pi_eta_gen",     ev.d0_pi_eta_gen,      "d0_pi_eta_gen[nmeson]/F");
  t->Branch("d0_pi_phi_gen",     ev.d0_pi_phi_gen,      "d0_pi_phi_gen[nmeson]/F");
  t->Branch("d0_pi_dxy_gen",     ev.d0_pi_dxy_gen,      "d0_pi_dxy_gen[nmeson]/F");
  t->Branch("d0_pi_dxyE_gen",    ev.d0_pi_dxyE_gen,     "d0_pi_dxyE_gen[nmeson]/F");
  t->Branch("d0_pi_dz_gen",      ev.d0_pi_dz_gen,       "d0_pi_dz_gen[nmeson]/F");
  ...
  t->Branch("d0_k_pt_gen",       ev.d0_k_pt_gen,        "d0_k_pt_gen[nmeson]/F");
  t->Branch("d0_k_eta_gen",      ev.d0_k_eta_gen,       "d0_k_eta_gen[nmeson]/F");
  t->Branch("d0_k_phi_gen",      ev.d0_k_phi_gen,       "d0_k_phi_gen[nmeson]/F");
  t->Branch("d0_k_dxy_gen",      ev.d0_k_dxy_gen,       "d0_k_dxy_gen[nmeson]/F");
  t->Branch("d0_k_dxyE_gen",     ev.d0_k_dxyE_gen,      "d0_k_dxyE_gen[nmeson]/F");
  t->Branch("d0_k_dz_gen",       ev.d0_k_dz_gen,        "d0_k_dz_gen[nmeson]/F");
...
void attachToCharmEventTree(TTree *t, CharmEvent_t &ev)
{
  ...
  */
  ...
  t->SetBranchAddress("d0_pi_pt_gen",      ev.d0_pi_pt_gen);
  t->SetBranchAddress("d0_pi_eta_gen",     ev.d0_pi_eta_gen);
  t->SetBranchAddress("d0_pi_phi_gen",     ev.d0_pi_phi_gen);
  t->SetBranchAddress("d0_pi_dxy_gen",     ev.d0_pi_dxy_gen);
  t->SetBranchAddress("d0_pi_dxyE_gen",    ev.d0_pi_dxyE_gen);
  t->SetBranchAddress("d0_pi_dz_gen",      ev.d0_pi_dz_gen);
  ...
  t->SetBranchAddress("d0_k_pt_gen",       ev.d0_k_pt_gen);
  t->SetBranchAddress("d0_k_eta_gen",      ev.d0_k_eta_gen);
  t->SetBranchAddress("d0_k_phi_gen",      ev.d0_k_phi_gen);
  t->SetBranchAddress("d0_k_dxy_gen",      ev.d0_k_dxy_gen);
  t->SetBranchAddress("d0_k_dxyE_gen",     ev.d0_k_dxyE_gen);
  t->SetBranchAddress("d0_k_dz_gen",       ev.d0_k_dz_gen);
