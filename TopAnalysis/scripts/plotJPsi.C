...
if(name.Contains("fit")) name.ReplaceAll(TString::Format("_%s%s_", sample.Data(), tune[i].Data()), +"_"+sample);
...
TString name(TString::Format("LJets2015/2016/mtop/sPlot/sPlot/TopMass_Data_Bfrag_genreco_sPlot_jpsi1_xb.root"));
f = TFile::Open(name);
std::cout << name << std::endl;
/*
