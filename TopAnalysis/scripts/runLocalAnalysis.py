...
def main():
    ...
    parser.add_option(      '--flav',     dest='flav',        help='flavour splitting (for single files)',       default=-1,         type=int)
    parser.add_option(      '--isTT',     dest='isTT',        help='ttbar sample (for single files)',            action='store_true')
