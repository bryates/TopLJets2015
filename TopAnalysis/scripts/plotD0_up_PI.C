...
*/
std::vector<TString> tune = {"_central", "_uuup"}; 
std::vector<float> param = {0.955, 0.975};
...
TString name(TString::Format("LJets2015/2016/mtop/sPlot/sPlot/TopMass_up_PI%s_sPlot_d0.root",tune[i].Data()));
