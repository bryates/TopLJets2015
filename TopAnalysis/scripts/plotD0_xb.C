...
void plotD0_xb(TString sample="172v5", int epoch=0, bool fin=false, float best=0.) {
/*
...
std::cout << name << std::endl;
f->Close();
name.ReplaceAll("d01.root","d02.root");
f = TFile::Open(name);
/*
...
c1->SaveAs("LJets2015/2016/mtop/www/meson/morph/weights_d0_sig" + ext + b + "_d0.png");
c1->SaveAs("LJets2015/2016/mtop/www/meson/morph/weights_d0_sig" + ext + b + "_d0.pdf");
}
