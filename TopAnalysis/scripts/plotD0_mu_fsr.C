...
TString name(TString::Format("LJets2015/2016/mtop/sPlot/sPlot/TopMass_172v5%s_sPlot_d0_mu_tag_mu.root",tune[i].Data()));
if(tune[i].Contains("fsr"))
  name=TString::Format("LJets2015/2016/mtop/TopMass_%s_sPlot_d0_mu_tag_mu.root",tune[i].Data());
