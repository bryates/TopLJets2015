...
//	TString baseDir = "/afs/cern.ch/user/q/qhassan/public/Analysis/CMSSW_7_0_6_patch1/src/UserCode/TopAnalysis/test/analysis/data/";
	...
	TFile* f0  = TFile::Open(baseDir+"mu_plots/miniAOD_wjets_PU20bx25_new.root");
...
float no_scale_posw = h1->GetBinContent(5);
	...
	TFile* f1  = TFile::Open(baseDir+"mu_plots/miniAOD_DY_PU20bx25_new.root");
...
float no_scale_posdy = h2->GetBinContent(5);
	...
	TFile* f2  = TFile::Open(baseDir+"mu_plots/miniAOD_MC_v2_new.root");
...
float no_scale_posttbar = h3->GetBinContent(5);
	...
	TFile* f3  = TFile::Open(baseDir+"mu_plots/miniAOD_QCD_80_120_Tune4C.root");
...
float no_scale_posqcd1 = h4->GetBinContent(5);
	...
	TFile* f4  = TFile::Open(baseDir+"mu_plots/miniAOD_QCD_120_170_Tune4C.root");
...
float no_scale_posqcd2 = h5->GetBinContent(5);
	...
	TFile* f5  = TFile::Open(baseDir+"mu_plots/miniAOD_QCD_170_300_Tune4C.root");
...
float no_scale_posqcd3 = h6->GetBinContent(5);
	...
	TFile* f6  = TFile::Open(baseDir+"mu_plots/miniAOD_QCD_300_470_Tune4C.root");
...
float no_scale_posqcd4 = h7->GetBinContent(5);
	...
	TFile* f7  = TFile::Open(baseDir+"mu_plots/miniAOD_QCD_470_600_Tune4C.root");
...
float no_scale_posqcd5 = h8->GetBinContent(5);
	...
	TFile* f8  = TFile::Open(baseDir+"mu_plots/miniAOD_QCD_600_800_Tune4C.root");
...
float no_scale_posqcd6 = h9->GetBinContent(5);
	...
	TFile* f9  = TFile::Open(baseDir+"mu_plots/miniAOD_QCD_800_1000_Tune4C.root");
...
float no_scale_posqcd7 = h10->GetBinContent(5);
	...
	TFile* f10  = TFile::Open(baseDir+"mu_plots/miniAOD_QCD_1000_1400_Tune4C.root");
...
float no_scale_posqcd8 = h11->GetBinContent(5);
	...
	TFile* f11  = TFile::Open(baseDir+"mu_plots/miniAOD_QCD_1400_1800_Tune4C.root");
...
float no_scale_posqcd9 = h12->GetBinContent(5);
	...
	TFile* f12  = TFile::Open(baseDir+"mu_plots/miniAOD_QCD_1800_2400_Tune4C.root");
...
float no_scale_posqcd10 = h13->GetBinContent(5);
	...
	TFile* f13  = TFile::Open(baseDir+"mu_plots/miniAOD_QCD_2400_3200_Tune4C.root");
...
float no_scale_posqcd11 = h14->GetBinContent(5);
	...
	TFile* f14  = TFile::Open(baseDir+"mu_plots/miniAOD_QCD_3200_Tune4C.root");
...
float total_qcd_pos = no_scale_posqcd1 + no_scale_posqcd2 + no_scale_posqcd3 + no_scale_posqcd4 + no_scale_posqcd5 + no_scale_posqcd6 + no_scale_posqcd7 + no_scale_posqcd8 + no_scale_posqcd9 + no_scale_posqcd10 + no_scale_posqcd11 + no_scale_posqcd12;
	...
	TFile* f15  = TFile::Open(baseDir+"mu_plots/miniAOD_TToLeptons_s_channel_new.root");
...
float no_scale_posst1 = h16->GetBinContent(5);
	...
	TFile* f16  = TFile::Open(baseDir+"mu_plots/miniAOD_TBarToLeptons_s_channel_new.root");
...
float no_scale_posst2 = h17->GetBinContent(5);
	...
	TFile* f17  = TFile::Open(baseDir+"mu_plots/miniAOD_TToLeptons_t_channel_new.root");
...
float no_scale_posst3 = h18->GetBinContent(5);
	...
	TFile* f18  = TFile::Open(baseDir+"mu_plots/miniAOD_TBarToLeptons_t_channel_new.root");
...
float no_scale_posst4 = h19->GetBinContent(5);
	...
	TFile* f19  = TFile::Open(baseDir+"mu_plots/miniAOD_T_tW_channel_new.root");
...
float no_scale_posst5 = h20->GetBinContent(5);
	...
	TFile* f20  = TFile::Open(baseDir+"mu_plots/miniAOD_Tbar_tW_channel_new.root");
