...
FragmentationAnalyzer::FragmentationAnalyzer(const edm::ParameterSet& iConfig) :
  ...
  hadronBunc(iConfig.getParameter<std::vector<double> >("hadronBunc")),
  ...
  for(size_t i=0; i<nhadrons; i++)
    {
      ...
      histos_["xb_BDzcharged"+name] = fs->make<TH1F>(("xb_BDzcharged"+name).c_str(), (name+";#it{x}_{b}=#it{p}_{T}(B)/#it{p}_{T}(jet); Jets").c_str(), 100, 0, 2);
      histos_["xb_BDzbcharged"+name] = fs->make<TH1F>(("xb_BDzbcharged"+name).c_str(), (name+";#it{x}_{b}=#it{p}_{T}(B)/#it{p}_{T}(jet); Jets").c_str(), 100, 0, 2);
      histos_["xb_B0Dzcharged"+name] = fs->make<TH1F>(("xb_B0Dzcharged"+name).c_str(), (name+";#it{x}_{b}=#it{p}_{T}(B)/#it{p}_{T}(jet); Jets").c_str(), 100, 0, 2);
      histos_["xb_B0Dzucharged"+name] = fs->make<TH1F>(("xb_B0Dzucharged"+name).c_str(), (name+";#it{x}_{b}=#it{p}_{T}(B)/#it{p}_{T}(jet); Jets").c_str(), 100, 0, 2);
      histos_["xb_BpmDzcharged"+name] = fs->make<TH1F>(("xb_BpmDzcharged"+name).c_str(), (name+";#it{x}_{b}=#it{p}_{T}(B)/#it{p}_{T}(jet); Jets").c_str(), 100, 0, 2);
      histos_["xb_BpmDzucharged"+name] = fs->make<TH1F>(("xb_BpmDzucharged"+name).c_str(), (name+";#it{x}_{b}=#it{p}_{T}(B)/#it{p}_{T}(jet); Jets").c_str(), 100, 0, 2);
      histos_["xb_BsDzcharged"+name] = fs->make<TH1F>(("xb_BsDzcharged"+name).c_str(), (name+";#it{x}_{b}=#it{p}_{T}(B)/#it{p}_{T}(jet); Jets").c_str(), 100, 0, 2);
      histos_["xb_BsDzucharged"+name] = fs->make<TH1F>(("xb_BsDzucharged"+name).c_str(), (name+";#it{x}_{b}=#it{p}_{T}(B)/#it{p}_{T}(jet); Jets").c_str(), 100, 0, 2);
      histos_["xb_BLbDzcharged"+name] = fs->make<TH1F>(("xb_BLbDzcharged"+name).c_str(), (name+";#it{x}_{b}=#it{p}_{T}(B)/#it{p}_{T}(jet); Jets").c_str(), 100, 0, 2);
      histos_["xb_BLbDzucharged"+name] = fs->make<TH1F>(("xb_BLbDzucharged"+name).c_str(), (name+";#it{x}_{b}=#it{p}_{T}(B)/#it{p}_{T}(jet); Jets").c_str(), 100, 0, 2);
      histos_["xb_B0Dzdcharged"+name] = fs->make<TH1F>(("xb_B0Dzdcharged"+name).c_str(), (name+";#it{x}_{b}=#it{p}_{T}(B)/#it{p}_{T}(jet); Jets").c_str(), 100, 0, 2);
      ...
      histos_["xb_B0Dzbcharged"+name] = fs->make<TH1F>(("xb_B0Dzbcharged"+name).c_str(), (name+";#it{x}_{b}=#it{p}_{T}(B)/#it{p}_{T}(jet); Jets").c_str(), 100, 0, 2);
      histos_["xb_B0Dzbucharged"+name] = fs->make<TH1F>(("xb_B0Dzbucharged"+name).c_str(), (name+";#it{x}_{b}=#it{p}_{T}(B)/#it{p}_{T}(jet); Jets").c_str(), 100, 0, 2);
      histos_["xb_BpmDzbcharged"+name] = fs->make<TH1F>(("xb_BpmDzbcharged"+name).c_str(), (name+";#it{x}_{b}=#it{p}_{T}(B)/#it{p}_{T}(jet); Jets").c_str(), 100, 0, 2);
      histos_["xb_BpmDzbucharged"+name] = fs->make<TH1F>(("xb_BpmDzbucharged"+name).c_str(), (name+";#it{x}_{b}=#it{p}_{T}(B)/#it{p}_{T}(jet); Jets").c_str(), 100, 0, 2);
      histos_["xb_BsDzbcharged"+name] = fs->make<TH1F>(("xb_BsDzbcharged"+name).c_str(), (name+";#it{x}_{b}=#it{p}_{T}(B)/#it{p}_{T}(jet); Jets").c_str(), 100, 0, 2);
      histos_["xb_BsDzbucharged"+name] = fs->make<TH1F>(("xb_BsDzbucharged"+name).c_str(), (name+";#it{x}_{b}=#it{p}_{T}(B)/#it{p}_{T}(jet); Jets").c_str(), 100, 0, 2);
      histos_["xb_BLbDzbcharged"+name] = fs->make<TH1F>(("xb_BLbDzbcharged"+name).c_str(), (name+";#it{x}_{b}=#it{p}_{T}(B)/#it{p}_{T}(jet); Jets").c_str(), 100, 0, 2);
      histos_["xb_BLbDzbucharged"+name] = fs->make<TH1F>(("xb_BLbDzbucharged"+name).c_str(), (name+";#it{x}_{b}=#it{p}_{T}(B)/#it{p}_{T}(jet); Jets").c_str(), 100, 0, 2);
      histos_["xb_B0Dzbdcharged"+name] = fs->make<TH1F>(("xb_B0Dzbdcharged"+name).c_str(), (name+";#it{x}_{b}=#it{p}_{T}(B)/#it{p}_{T}(jet); Jets").c_str(), 100, 0, 2);
      histos_["xb_BpmDzbdcharged"+name] = fs->make<TH1F>(("xb_BpmDzbdcharged"+name).c_str(), (name+";#it{x}_{b}=#it{p}_{T}(B)/#it{p}_{T}(jet); Jets").c_str(), 100, 0, 2);
      histos_["xb_BsDzbdcharged"+name] = fs->make<TH1F>(("xb_BsDzbdcharged"+name).c_str(), (name+";#it{x}_{b}=#it{p}_{T}(B)/#it{p}_{T}(jet); Jets").c_str(), 100, 0, 2);
      histos_["xb_BLbDzbdcharged"+name] = fs->make<TH1F>(("xb_BLbDzbdcharged"+name).c_str(), (name+";#it{x}_{b}=#it{p}_{T}(B)/#it{p}_{T}(jet); Jets").c_str(), 100, 0, 2);
      ...
      if(jinfo.hasSemiLepDecay) 
	{
	  ...
	  histos_["semilepbrinc"]->Fill(0);
          ...
          if(jinfo.leadTagId==511 && jinfo.charmId==421) {
            ...
            histos_["xb_BsDzbuchargedinc"]->Fill(jinfo.xb_charged_charm, bwgt[0]*(1-bwgt[0]));
            histos_["xb_BLbDzbuchargedinc"]->Fill(jinfo.xb_charged_charm, bwgt[0]*(1-bwgt[0]));
            histos_["xb_B0Dzbdchargedinc"]->Fill(jinfo.xb_charged_charm, bwgt[0]*(1-bwgt[0]));
            histos_["xb_BpmDzbdchargedinc"]->Fill(jinfo.xb_charged_charm, bwgt[0]*(1+bwgt[0]));
          ...
          if(jinfo.leadTagId==521 && jinfo.charmId==421) {
            ...
            histos_["xb_BsDzbuchargedinc"]->Fill(jinfo.xb_charged_charm, bwgt[1]*(1-bwgt[1]));
            histos_["xb_BLbDzbuchargedinc"]->Fill(jinfo.xb_charged_charm, bwgt[1]*(1-bwgt[1]));
            histos_["xb_B0Dzbdchargedinc"]->Fill(jinfo.xb_charged_charm, bwgt[1]*(1+bwgt[1]));
            histos_["xb_BpmDzbdchargedinc"]->Fill(jinfo.xb_charged_charm, bwgt[1]*(1-bwgt[1]));
          ...
          if(jinfo.leadTagId==531 && jinfo.charmId==421) {
            ...
            histos_["xb_BsDzbuchargedinc"]->Fill(jinfo.xb_charged_charm, bwgt[2]*(1+bwgt[2]));
            histos_["xb_BLbDzbuchargedinc"]->Fill(jinfo.xb_charged_charm, bwgt[2]*(1-bwgt[2]));
            histos_["xb_B0Dzbdchargedinc"]->Fill(jinfo.xb_charged_charm, bwgt[2]*(1+bwgt[2]));
            histos_["xb_BpmDzbdchargedinc"]->Fill(jinfo.xb_charged_charm, bwgt[2]*(1+bwgt[2]));
          ...
          if(jinfo.leadTagId==5122 && jinfo.charmId==421) {
            ...
            histos_["xb_BsDzbuchargedinc"]->Fill(jinfo.xb_charged_charm, bwgt[3]*(1-bwgt[3]));
            histos_["xb_BLbDzbuchargedinc"]->Fill(jinfo.xb_charged_charm, bwgt[3]*(1+bwgt[3]));
            histos_["xb_B0Dzbdchargedinc"]->Fill(jinfo.xb_charged_charm, bwgt[3]*(1+bwgt[3]));
            histos_["xb_BpmDzbdchargedinc"]->Fill(jinfo.xb_charged_charm, bwgt[3]*(1+bwgt[3]));
