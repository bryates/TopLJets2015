...
analysis = cms.EDAnalyzer("MiniAnalyzer",
                          ...
                          elTriggersToUse = cms.vstring('HLT_Ele27_WPTight_Gsf_v', 'HLT_Ele32_WPTight_Gsf_v',
                                                        ...
                                                        'HLT_Mu23_TrkIsoVVL_Ele12_CaloId_LTrrackIDL_IsoVL_v', 'HLT_Mu23_TrkIsoVVL_Ele12_CaloId_LTrrackIDL_IsoVL_DZ_v',
                                                        'HLT_Mu12_TrkIsoVVL_Ele23_CaloId_LTrrackIDL_IsoVL_v', 'HLT_Mu12_TrkIsoVVL_Ele23_CaloId_LTrrackIDL_IsoVL_DZ_v')
                          )
