...
analysis = cms.EDAnalyzer("MiniAnalyzer",
                          ...
                          muTriggersToUse = cms.vstring('HLT_IsoMu24_v', 'HLT_IsoTkMu24_v',
                                                        'HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_v', 'HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v'),
                          elTriggersToUse = cms.vstring('HLT_Ele32_eta2p1_WPTight_Gsf_v',
                                                        'HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_v',                                                        'HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_v','HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v')
                          )
